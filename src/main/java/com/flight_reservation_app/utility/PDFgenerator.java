...
public class PDFgenerator {
    ...
    public void generatePDF(String filePath, String name, String email,String phone,String operatingAirlines,String departureDate,String departureCity,String arrivalCity) {
		try {
    ...
    public  void generateItenary(Reservation_details reservation, String filePath) {
        try {
            Document document = new Document();
            PdfWriter.getInstance(document, new FileOutputStream(filePath));
            document.open();
    ...
    private PdfPTable generateTable(Reservation_details reservation) {
    ...
    private static void addTitleAndTable(Document document, String name, String email, String phone, String operatingAirlines, String departureDate, String departureCity, String arrivalCity)
